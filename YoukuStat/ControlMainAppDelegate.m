...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    self.viewController = [[ControlMainViewController alloc] initWithNibName:@"ControlMainViewController" bundle:nil];
    ...
    //self.tabBarController = [[NavTabBarController alloc] initWithtabName:@[@"Youku", @"Tudou"]];
    //self.tabBarController.viewControllers = @[self.viewController, self.viewController];
